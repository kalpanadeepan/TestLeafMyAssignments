...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		elementCompanyNameclear.sendKeys("TestLeafUpdated");

		WebElement elementFirstNameUpdate = driver.findElement(By.id("createLeadForm_firstName"));
		elementFirstNameUpdate.clear();
		elementFirstNameUpdate.sendKeys("KalpanaSelvaraj");
		
		WebElement elementCreateButtonUpdate = driver.findElement(By.className("smallSubmit"));
		elementCreateButtonUpdate.click();
